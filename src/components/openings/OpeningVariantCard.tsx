...
export function OpeningVariantCard({ variant }: OpeningVariantCardProps) {
  return (
    <article
      className={cn(
        "relative overflow-hidden rounded-2xl border border-white/10 bg-background-secondary/90 p-4 shadow-lg transition-transform duration-200",
